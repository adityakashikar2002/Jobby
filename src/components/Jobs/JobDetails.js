...
const JobDetails = () => {
  ...
  useEffect(() => {
    const fetchJobDetails = async () => {
      try {
        setLoading(true);
        const data = await getJobDetails(authToken, id);
...
//       // navigate('/login');
//     }
//   }, [id, isAuthenticated, authLoading]); // Depend on id, isAuthenticated, and authLoading

//   if (loading || authLoading) { // Show loader if auth is still loading or job details are loading
//     return <Loader />;
//   }
